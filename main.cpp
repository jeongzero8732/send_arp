...
uint8_t* recv_packet;
void find_mac();
void make_arp_request(char*);
void make_eth_packet();
...
int main(int arc, char* argv[])
{
    ...
    puts("");
    //for(int i=42;i<sizeof(send_packet);i++){send_packet[i]=i%256;}
...
void make_arp_request(/*ETHER_HDR* ether_hdr, ARP_HDR* arp_hdr, */char* sender_ip)
{
    ...
    memcpy(send_packet+14,(uint8_t*)arp_hdr,28);
/*
...
//arp_hdr->sender_ipaddr[0]=0xa;
 //arp_hdr->sender_ipaddr[1]=0xa;
 //arp_hdr->sender_ipaddr[2]=0xa;
 //arp_hdr->sender_ipaddr[3]=0xa;
	memcpy(arp_hdr->sender_ipaddr,inet_addr("192.168.0.4"),4);
*/
}
